...
\begin{frame}{Results: Quantitative}
  ...
  \end{center}
  \vspace{0.5em}
  The gap is not marginal: U-Net leads DeepLabV3 by \textbf{0.24 IoU points}
...
\begin{frame}{Results: Visual Comparison}
  ...
  \vspace{0.4em}
  \centering
  This is precisely the failure mode one would predict for a model
...
\begin{frame}{Why U-Net Outperforms DeepLabV3}
  We think this result deserves a careful interpretation rather than a quick dismissal. \\[0.4em]
  ...
  \begin{block}{We believe the explanation is a design mismatch}
