...
backbone push well beyond it. Notably, U-Net, trained from scratch with skip
...
The gap is not marginal: U-Net leads DeepLabV3 by roughly 0.24 IoU points
...
This tells us that the model is slightly underconfident, assigning probabilities
...
This is precisely the failure mode one would predict for a model whose
...
We believe the explanation lies in a mismatch between what DeepLabV3 was designed to solve
...
The performance ordering closely mirrors each method's ability to exploit
